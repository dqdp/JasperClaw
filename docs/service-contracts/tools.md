...
- operational alert delivery uses a dedicated alert bot plus auth token, with severity-aware routing for default/warning/critical recipient groups and durable retry/dedupe semantics keyed by caller-supplied alert idempotency keys
